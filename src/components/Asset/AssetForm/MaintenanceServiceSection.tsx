...
function MaintenanceServiceSection({
  ...
  const handleDateRangeChange = (range: DateRange | null) => {
    if (range) {
      handleChange("maintenanceStartDate", range.startDate);
      handleChange("maintenanceEndDate", range.endDate);
    } else {
      handleChange("maintenanceStartDate", undefined);
      handleChange("maintenanceEndDate", undefined);
    }
  };
