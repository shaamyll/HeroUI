            ...
            <div className="mb-8">
                ...
                <div className="flex flex-wrap gap-2">
                    ...
                    {value.images.map((image) => (
                        <div key={image.id} className="relative w-20 h-20 border border-gray-300 rounded-lg overflow-hidden">
                            <img
                                src={image.url}
                                alt="Uploaded"
                    ...
                    {/* Add Image button */}
                    <label className="w-20 h-20 border-2 border-dashed border-gray-300 rounded-lg flex items-center justify-center cursor-pointer hover:bg-gray-50 transition-colors">
                        <input
                            type="file"
                            accept="image/*"
                            multiple
                        ...
                        <div className="text-center">
                            <Camera className="w-4 h-4 text-gray-700 mx-auto mb-1" />
                            <p className="text-xs font-semibold text-gray-600">Add Image</p>
                        </div>
                    </label>
                </div>
            </div>
                ...
                {value.documents.length > 0 ? (
                    <div className="space-y-2 mt-3">
                        {value.documents.map(doc => (
                            <div key={doc.id} className="flex items-center justify-between p-3 hover:bg-white bg-gray-100 border border-gray-300 shadow hover:shadow-md rounded-lg">
